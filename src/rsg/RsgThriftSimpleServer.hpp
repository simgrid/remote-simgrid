...
namespace apache {
    namespace thrift {
        namespace server {
            ...
            */
            class RsgThriftSimpleServer : public RsgThriftServerFramework {
            public:
                RsgThriftSimpleServer(
                ...
                #endif // #ifndef _RSG_THRIFT_SERVER_TSIMPLESERVER_H_
